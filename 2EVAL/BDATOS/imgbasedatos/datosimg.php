...
name, almacena el nombre del fichero type, el tipo o extensión (se podrá limitar el tipo de archivos a subir) size, el tamaño (se podrá limitar el tamaño de los archivos a subir) tmp_name, el nombre del directorio temporal utilizado de forma previa al alojamiento definitivo del fichero
