...
if (isset($_POST['conexión'])) {
   ...
   if (usuario_existe($identificador,$contraseña)) {
      // El usuario existe ...
      // Iniciar una sesión y registrar los datos
      // de sesión.
      session_start();
      $_SESSION['fecha'] = date('\l\e d/m/Y à H:i:s');
      $_SESSION['identificador'] = $identificador;
      // A continuación, redirigir al usuario a una página de inicio. 
      // llamando a la función genérica url() para estar
      // seguros de que el identificador de la sesión se transmite
      // independientemente de las condiciones.
      header('location: '.url('11-sesion-autenticacion-inicio.php'));
      exit;
   } else {
...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    <form action="11-sesion-autenticacion-login.php" method="post">
    <table border="0">
    <tr>
